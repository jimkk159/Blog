...
export const DUMMY_Structure = [
  {
    ...
    topic: "React",
    parent: "Node",
    childs: ["Redux", "React-Router"],
  },
  { id: 7, level: 5, topic: "React-Router", parent: "React", childs: [] },
  { id: 9, level: 5, topic: "Test22", parent: "Express", childs: [] },
  { id: 6, level: 5, topic: "Redux", parent: "React", childs: [] },
  { id: 0, level: 0, topic: "Root", parent: "", childs: ["CS"] },
  { id: 8, level: 5, topic: "Test1", parent: "Express", childs: [] },
  { id: 1, level: 1, topic: "CS", parent: "Root", childs: ["JS"] },
  {
    id: 3,
    level: 3,
    topic: "Node",
    parent: "JS",
    childs: ["Express", "React"],
  },
  { id: 2, level: 2, topic: "JS", parent: "CS", childs: ["Node"] },
  {
    id: 4,
    level: 4,
    topic: "Express",
    parent: "Node",
    childs: ["Test1", "Test22", "Test333"],
  },
  { id: 10, level: 5, topic: "Test333", parent: "Express", childs: [] },
];
